...
| --- | --- | --- | --- | --- | --- | --- |
| Vercel production | `VERCEL_ENV=production`, `NODE_ENV=production` | `NEXT_PUBLIC_SITE_URL` required | Disabled | `RATE_LIMIT_HMAC_SECRET` required | Indexable | Enabled unless explicitly disabled |
...
| Non-Vercel production | `NODE_ENV=production`, no `VERCEL_ENV` | `NEXT_PUBLIC_SITE_URL` required | Disabled | `RATE_LIMIT_HMAC_SECRET` required | Indexable | Enabled unless explicitly disabled |
